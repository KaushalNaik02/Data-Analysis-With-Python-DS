...
# installed.
TCL_PREFIX='G:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='G:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='G:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IG:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LG:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='G:/KN_Udemy/Data-Analysis-With-Python-DS/venvDA\Library\lib\tclstub86.lib'
